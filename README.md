...
- Todos los cursos tienen QR, incluido el **Taller de fortalecimiento**. La bandera `asistencia_obligatoria` (en `false` para el Taller) controla solo si el **cierre automático penaliza**: en el Taller se puede escanear el QR y queda el registro, pero **no se genera Falta/Tardanza ni multas** por no marcar.
